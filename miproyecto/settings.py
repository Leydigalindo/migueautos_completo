...
SECRET_KEY = 'django-insecure-3mc&#fe6-=@k^fj+w_8pz#wbc@9xrsb^5kdat@*np$#3qn7=56'
...
ACCOUNT_EMAIL_VERIFICATION = 'none'# Es necesaria la verificacion del email --no

LOGIN_REDIRECT_URL = 'index' #a donde me manda cuando inicie sesion (index)

ACCOUNT_LOGOUT_ON_GET = True

ACCOUNT_EMAIL_VERIFICATION = 'mandatory' # verificacion del corerro obligatoria
ACCOUNT_EMAIL_REQUIRED = True #Es necesario un correo
ACCOUNT_USERNAME_REQUIRED = False #no es necesario un apodo para crear un usuario
ACCOUNT_AUTHENTICATION_METHOD = 'email'# se verifica mediante email
